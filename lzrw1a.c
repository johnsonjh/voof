/* Here is the C code for my LZRW1-A algorithm.

(Note: This algorithm is implemented according to an internal data
compression interface standard which I have been using since 1989,
which is the basis for, but is not identical to, the interface
I have recently proposed in comp.compression).
...
/* Date     : 25 June 1991.                                                   */
/* Release  : 1.                                                              */
/* FTP from : sirius.ucs.adelaide.edu.au (129.127.40.3)  /pub/compression     */
/*                                                                            */
/******************************************************************************/
/*                                                                            */
